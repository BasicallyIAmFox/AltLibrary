...
namespace AltLibrary.Common.Systems {
	public class WorldBiomeManager : ModSystem {
		...
		public static bool IsCorruption => string.IsNullOrEmpty(WorldEvil) && !WorldGen.crimson;
		public static bool IsCrimson => string.IsNullOrEmpty(WorldEvil) && WorldGen.crimson;
		public static bool IsAnyModdedEvil => string.IsNullOrEmpty(WorldEvil) && !WorldGen.crimson;
		public static bool IsDrunkCorrupt => Main.drunkWorld && drunkEvil == "Terraria/Corruption";
		public static bool IsDrunkCrimson => Main.drunkWorld && drunkEvil == "Terraria/Crimson";
		public static bool IsDrunkSomething => Main.drunkWorld && drunkEvil != "Terraria/Corruption" && drunkEvil != "Terraria/Crimson";
		public static bool IsHallow => string.IsNullOrEmpty(WorldHallow);
		public static bool IsAnyModdedGood => !IsHallow;
		public static bool IsJungle => string.IsNullOrEmpty(WorldJungle);
		public static bool IsAnyModdedJungle => !IsJungle;
		public static bool IsUnderworld => string.IsNullOrEmpty(WorldHell);
		public static bool IsAnyModdedHell => !IsUnderworld;
		...
		internal static void AnalysisTiles(bool includeText = true) {
			...
			static void text(object threadContext) {
		...
		public static AltBiome GetEvilBiome() => IsAnyModdedEvil ? ModContent.Find<AltBiome>(WorldEvil) : null;
		public static AltBiome GetDrunkEvilBiome() => IsDrunkSomething ? ModContent.Find<AltBiome>(drunkEvil) : null;
		public static AltBiome GetHallowBiome() => IsHallow ? null : ModContent.Find<AltBiome>(WorldHallow);
		public static AltBiome GetJungleBiome() => IsJungle ? null : ModContent.Find<AltBiome>(WorldJungle);
		public static AltBiome GetHellBiome() => IsUnderworld ? null : ModContent.Find<AltBiome>(WorldHell);
	}
}
