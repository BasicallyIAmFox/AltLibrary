...
namespace AltLibrary.Core
{
    internal class ILHooks
    {
        ...
        private static void WorldGen_GERunner(ILContext il)
        {
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(164))) { AltLibrary.Instance.Logger.Info("Error here! $21"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(403))) { AltLibrary.Instance.Logger.Info("Error here! $22"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(402))) { AltLibrary.Instance.Logger.Info("Error here! $23"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldHallow != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldHallow).BiomeHardenedSand.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(117))) { AltLibrary.Instance.Logger.Info("Error here! $25"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldHallow != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldHallow).BiomeStone.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(116))) { AltLibrary.Instance.Logger.Info("Error here! $26"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldHallow != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldHallow).BiomeSand.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(164))) { AltLibrary.Instance.Logger.Info("Error here! $27"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldHallow != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldHallow).BiomeIce.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(217))) { AltLibrary.Instance.Logger.Info("Error here! $29"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(220))) { AltLibrary.Instance.Logger.Info("Error here! $30"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldEvil != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldEvil).WallContext.wallsReplacement.ContainsKey(217))
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(25))) { AltLibrary.Instance.Logger.Info("Error here! $31"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldEvil != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldEvil).BiomeStone.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(25))) { AltLibrary.Instance.Logger.Info("Error here! $34"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldEvil != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldEvil).BiomeStone.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(112))) { AltLibrary.Instance.Logger.Info("Error here! $35"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldEvil != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldEvil).BiomeSand.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(109))) { AltLibrary.Instance.Logger.Info("Error here! $36"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldHallow != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldHallow).BiomeGrass.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(23))) { AltLibrary.Instance.Logger.Info("Error here! $37"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldEvil != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldEvil).BiomeGrass.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(117))) { AltLibrary.Instance.Logger.Info("Error here! $38"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldHallow != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldHallow).BiomeStone.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(25))) { AltLibrary.Instance.Logger.Info("Error here! $39"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldEvil != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldEvil).BiomeStone.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(116))) { AltLibrary.Instance.Logger.Info("Error here! $40"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldHallow != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldHallow).BiomeSand.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(112))) { AltLibrary.Instance.Logger.Info("Error here! $41"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldEvil != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldEvil).BiomeSand.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(164))) { AltLibrary.Instance.Logger.Info("Error here! $42"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldHallow != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldHallow).BiomeIce.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(163))) { AltLibrary.Instance.Logger.Info("Error here! $43"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldEvil != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldEvil).BiomeIce.HasValue)
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(400))) { AltLibrary.Instance.Logger.Info("Error here! $44"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
            ...
            if (!c.TryGotoNext(i => i.MatchLdcI4(398))) { AltLibrary.Instance.Logger.Info("Error here! $45"); return; } c.Index++;
            c.EmitDelegate<Func<ushort, ushort>>((orig) =>
            {
                ushort value = orig;
                if (WorldBiomeManager.worldEvil != "" && ModContent.Find<AltBiome>(WorldBiomeManager.worldEvil).BiomeHardenedSand.HasValue)
